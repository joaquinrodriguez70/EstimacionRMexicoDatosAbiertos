#Downloading data from http://187.191.75.115/gobmx/salud/datos_abiertos/datos_abiertos_covid19.zip
...
#dataframe with country wide cases, state number, state name, days to cut off	, savetoFile (TRUE or FALSE), path
